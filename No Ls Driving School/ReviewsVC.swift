...
class ReviewsVC: UIViewController {
    ...
    private let contentLabel = LSLabel(text: "We have loads of 5 star reviews on Google, Facebook and Free Index. We would love it if you were to leave a review too!", textColor: AppColor.darkestGray, fontSize: 18, textAlignment: .center, numberOfLines: 0)
