...
class TheoryVC: UIViewController {
    ...
    private let contentLabel = LSLabel(text: "It's important that you prepare thoroughly for the theory test. That's why we've made Theory Test Pro available for free to all our pupils.", textColor: AppColor.darkestGray, fontSize: 20, textAlignment: .center, numberOfLines: 0)
